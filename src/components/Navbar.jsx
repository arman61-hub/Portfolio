      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/30 dark:bg-black/30 backdrop-blur-md shadow-md">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            {/* Logo */}
            <div
              className="text-4xl font-bold bg-gradient-to-r from-[#5f6fff] via-[#7f53ff] to-[#ff6fc8] text-transparent bg-clip-text font-[Charm]"
            ...
            <div className="hidden md:flex items-center space-x-6">
              {navLinks.map(({ name, to, icon }) => (
                <Link
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-md font-medium cursor-pointer transition-all duration-300 ${
                    activeLink === to
          ...
          {menuOpen && (
            <div className="md:hidden animate-slideDown py-4 rounded-xl bg-white/30 dark:bg-black/30 backdrop-blur-lg shadow-lg">
