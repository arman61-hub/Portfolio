...
const Home = () => {
  ...
  return (
    <div name="Home" className="w-full min-h-screen flex items-center justify-center px-4 py-16 text-[#00040f] dark:text-[#e1e1e1]">
      <div className="max-w-7xl w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        <div className="text-center md:text-left flex-1">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-snug sm:leading-tight">
            Hi, there! <br />
            I'm <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">{text}</span>
            <span className="text-gray-400"><Cursor cursorStyle="|" /></span>
          </h2>
          ...
          <div className="mt-6 px-2">
            <strong>
              <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-lg mx-auto md:mx-0 leading-relaxed">
                Programming enthusiast who often thinks about developing new things for solving real world problems.
              </p>
            </strong>
          </div>
        </div>
